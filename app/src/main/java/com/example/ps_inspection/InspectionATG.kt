...
class InspectionATG : Fragment() {
    ...
    private fun updateUIFromData(data: InspectionATGData) {
        ...
        updateEditTextIfNeeded(binding.atg3BPressure220, data.atg3_b_pressure_220)
    ...
    private fun setupInputListeners() {
        ...
        // ... добавьте слушатели для всех остальных полей аналогично

        // Для примера покажу несколько, остальные делаются по аналогии:
